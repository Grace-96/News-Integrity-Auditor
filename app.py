...
# ------------------------------------------------------------------
# 1. UTILITY FUNCTIONS AND TEXT CLEANING
# ------------------------------------------------------------------
...
st.markdown("""
    ...
    .stButton>button { background-color: #DC143C; color: white; }
    p, h1, h2, h3, h4, .stMarkdown { color: #FAFAFA !important; }
    </style>
...
with st.expander("▶️ **SYSTEM OVERVIEW AND PROTOCOL**"):
    st.markdown("""
        ...
        * **Cloud Engine:** Remote model hosting via Hugging Face.
    """)
